  ...
  return (
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919]  dark:bg-slate-800">
        <div className="flex flex-col p-10 bg-[#2B2929] dark:bg-slate-800 text-white space-y-5">
          <h1 className="text-5xl font-bold">
            Welcome to SDropbox. <br />
            <br />
            Storing everything for your and your Business needs. All in one
            place.
          </h1>
          <p className="pb-20">
      ...
      <p className="text-center font-light p-2">
        ...
        don not own or affiliated wit Dropbox or/and any of its subsidiaries in
        any form. copyright Disclaimer under section 107 of the Copyright Act
        1976, allowance is made for "fair use" of this website for education
        purposes.
      </p>
    </main>
  );
